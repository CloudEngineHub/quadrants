...
def tensor_vec(n, dtype, shape, *, backend=Backend.FIELD, **kwargs):
    ...
    """
    backend = _coerce_backend(backend)
    from quadrants.lang.matrix import Vector  # pylint: disable=C0415
...
def tensor_annotation(backend):
    ...
    """
    backend = _coerce_backend(backend)
    from quadrants import types as _types  # pylint: disable=C0415
    from quadrants.types.annotations import template  # pylint: disable=C0415
